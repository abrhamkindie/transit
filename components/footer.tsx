        ...
        <div className="grid gap-12 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted max-w-xs">
              Your trusted partner in international customs clearance and logistics.
              We handle all customs formalities end-to-end.
            </p>
            <div className="mt-6 flex items-center gap-2.5">
              ...
              { label: "Facebook", href: "#", path: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" },
                ...
                <a
                  key={s.label}
                  href={s.href}
                  className="flex h-9 w-9 items-center justify-center rounded-lg border border-border bg-white text-muted transition-all hover:border-primary/30 hover:text-primary hover:shadow-sm hover:-translate-y-0.5"
                  aria-label={s.label}
                >
          ...
          {/* Links */}
          <div>
            <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted">Links</h3>
            <ul className="mt-5 space-y-3">
              {[
                ...
                <li key={l.href}>
                  <Link
                    href={l.href}
                    className="text-sm text-muted transition-all hover:text-primary hover:pl-0.5"
                  >
                    {l.label}
                  </Link>
                </li>
          ...
          {/* Services */}
          <div>
            <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted">Services</h3>
            <ul className="mt-5 space-y-3">
              {[
          ...
          {/* Contact */}
          <div>
            <h3 className="text-[11px] font-bold uppercase tracking-[0.15em] text-muted">Contact</h3>
